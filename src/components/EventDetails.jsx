        ...
        <div className="modal-overlay">
          <div className={`modal ${isLambo ? "lambo-modal" : isFerrari ? "ferrari-modal" : isPagani ? "pagani-modal" : isRolls ? "rolls-modal" : isUltimateParis ? "ultimate-modal" : "porsche-modal"}`}>
            ...
            <div className="payment-tabs">
               ...
               <button onClick={() => setMetodo("boleto")} className={metodo === "boleto" ? (isBoleto => metodo === "boleto" ? (isLambo ? "active-lambo" : isFerrari ? "active-ferrari" : isPagani ? "active-pagani" : isRolls ? "active-rolls" : isUltimateParis ? "active-ultimate" : "active-porsche") : "") : ""}>Boleto</button>
            </div>
